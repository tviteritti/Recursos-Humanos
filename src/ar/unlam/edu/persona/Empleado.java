...
public class Empleado extends Persona{	
	//un trabajador comun, no es jefe
//plus por nunca faltar - presentismo

	public Empleado(Integer numLegajo, Integer dni, String nombre, String apellido, Calendario fechaDeNacimiento, Double salario, Integer antiguedad) {
